...
<html>
    ...
    <body>
        <ul style="margin:auto">
            <li>
                <a href="">
                    ${ideaWithNewFeature.idea.ideaTitle}
                </a>
                <ul class="features">
                    <c:forEach items="${ideaWithNewFeature.idea.features}" var="feature">
                        <li>
        ...
        <div class="developIdeaDiv" style="font-size: larger; position:absolute; top:90%; width:100%">
            <input type="button" id="newFeatureButton" class="mdl-button mdl-js-button 
                   ...
                   style="width:20%; z-index: 9; margin-left:10px"/>
            <form:form action="/MindGames/develop/done" modelAttribute="ideaWithNewFeature" method="POST" style="display:inline">
                <form:hidden path="idea.ideaTitle" />
                <c:forEach items="${ideaWithNewFeature.idea.features}" varStatus="s">
                    <form:hidden path="idea.features[${s.index}].featureTitle" class="form-control" />
                    <form:hidden path="idea.features[${s.index}].descriptionShort" class="form-control" />
                </c:forEach>
                <form:button class="mdl-button mdl-js-button 
                             mdl-button--colored mdl-button--raised"
                             style="width:20%; z-index: 9">Done</form:button>
            </form:form>
            <div class="spacer" style="display:inline"><b>spacer</b></div>
            <input type="button" id="cancel" class="mdl-button mdl-js-button 
                   mdl-button--colored mdl-button--raised" value="Cancel"
                   style="width:20%; z-index: 9; float: right; margin-right:10px"/>
        </div>
